...
static GType
exo_icon_chooser_model_get_column_type (GtkTreeModel *tree_model, gint          idx)
{
    switch (idx)
    {
...
static gboolean  exo_icon_chooser_model_get_iter (GtkTreeModel *tree_model, GtkTreeIter  *iter, GtkTreePath  *path)
{
...
static GtkTreePath*
exo_icon_chooser_model_get_path (GtkTreeModel *tree_model, GtkTreeIter  *iter)
{
    ExoIconChooserModel *model = EXO_ICON_CHOOSER_MODEL (tree_model);
    gint                 idx;
...
static void  exo_icon_chooser_model_get_value (GtkTreeModel *tree_model, GtkTreeIter  *iter, gint          column, GValue       *value)
{
...
static gboolean  exo_icon_chooser_model_iter_children (GtkTreeModel *tree_model, GtkTreeIter  *iter, GtkTreeIter  *parent)
{
    ExoIconChooserModel *model = EXO_ICON_CHOOSER_MODEL (tree_model);
...
static gint
exo_icon_chooser_model_iter_n_children (GtkTreeModel *tree_model, GtkTreeIter  *iter)
{
    ExoIconChooserModel *model = EXO_ICON_CHOOSER_MODEL (tree_model);
...
static gboolean  exo_icon_chooser_model_iter_nth_child (GtkTreeModel *tree_model, GtkTreeIter  *iter, GtkTreeIter  *parent, gint          n)
{
    ExoIconChooserModel *model = EXO_ICON_CHOOSER_MODEL (tree_model);
...
static gboolean  exo_icon_chooser_model_iter_parent (GtkTreeModel *tree_model, GtkTreeIter  *iter, GtkTreeIter  *child)
{
    return FALSE;
}
   ...
   * have the basename of the symlink target */
    ...
    if (G_LIKELY (p != NULL))
    {
        ...
        if (G_LIKELY (item != NULL))
        {
            ...
            /* this item can be removed from the hash table, remaining data will be freed by the destroy func */
            merged = TRUE;
        }
    }
...
static void  exo_icon_chooser_model_icon_theme_changed (GtkIconTheme        *icon_theme, ExoIconChooserModel *model)
{
    ExoIconChooserModelItem *item;
    GHashTable              *items;
...
static gint
exo_icon_chooser_model_item_compare (gconstpointer data_a, gconstpointer data_b)
{
