 ...
 * either a thumbnail is available or a thumbnail could be generated using the GdkPixbuf library.
 **/
...
void exo_gtk_file_chooser_add_thumbnail_preview (GtkFileChooser *chooser) {
    ...
    g_signal_connect (G_OBJECT (chooser), "selection-changed", G_CALLBACK (update_preview), thumbnail_preview);
