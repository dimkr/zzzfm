...
ptk_file_icon_renderer_get_type ( void )
{
    ...
    if ( G_UNLIKELY( !renderer_type ) )
    {
        ...
        renderer_type = g_type_register_static ( GTK_TYPE_CELL_RENDERER_PIXBUF, "PtkFileIconRenderer", &renderer_info, 0 );
    }
...
static void  ptk_file_icon_renderer_class_init ( PtkFileIconRendererClass *klass )
{
    ...
    *   custom cell renderer properties */
    ...
    g_object_class_install_property ( object_class, PROP_FOLLOW_STATE,
...
#if GTK_CHECK_VERSION (3, 0, 0)
static void  ptk_file_icon_renderer_render ( GtkCellRenderer *cell,
                                cairo_t *cr,
                                GtkWidget *widget,
                                const GdkRectangle *background_area,
                                const GdkRectangle *cell_area,
